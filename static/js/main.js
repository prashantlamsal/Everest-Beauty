...
function updateCartCount(count) {
    // Use global function from base.html if available
    ...
    .then(data => {
        if (data.success) {
            if (isInWishlist) {
                ...
                const productDisplayName = productName || 'Product';
                showNotification(`${productDisplayName} is removed from your wishlist!`, 'info');
            } else {
                button.classList.add('active');
                button.innerHTML = '<i class="fas fa-heart"></i>';
                const productDisplayName = productName || 'Product';
                showNotification(`${productDisplayName} is added in your wishlist!`, 'success');
            }
        } else {
