...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard.context_processors.cart_and_wishlist_counts',
            ],
        },
    },
]
...
BRAND_NAME = config('BRAND_NAME', default='Everest Beauty')
SUPPORT_EMAIL = config('SUPPORT_EMAIL', default='support@everestbeauty.com')
SUPPORT_PHONE = config('SUPPORT_PHONE', default='+977-9800000000')
BUSINESS_HOURS = config('BUSINESS_HOURS', default='Sun-Fri 9am-6pm')
