...
urlpatterns = [
    ...
    path('cart/remove/<int:item_id>/', api_views.RemoveFromCartAPI.as_view(), name='remove_from_cart_api'),
    path('cart/update/<int:item_id>/', api_views.UpdateCartItemAPI.as_view(), name='update_cart_item_api'),
    path('wishlist/', api_views.WishlistAPI.as_view(), name='wishlist_api'),
    path('wishlist/add/<int:product_id>/', api_views.AddToWishlistAPI.as_view(), name='add_to_wishlist_api'),
    path('wishlist/remove/<int:product_id>/', api_views.RemoveFromWishlistAPI.as_view(), name='remove_from_wishlist_api'),
]
